...
Trino requires a 64-bit version of Java 24, with a minimum required version of 24.0.1. Also, Eclipse Temurin OpenJDK (provided by Adoptium) is the recommended JDK distribution for Trino.
